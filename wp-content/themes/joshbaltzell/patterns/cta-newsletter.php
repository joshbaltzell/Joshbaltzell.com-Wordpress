 ...
 * Slug: joshbaltzell/cta-newsletter
 * Categories: joshbaltzell-cta
 * Description: A newsletter signup call-to-action with watercolor background.
 */
?>
...
<p class="has-text-align-center has-muted-color has-text-color has-heading-font-family" style="font-size:var(--wp--preset--font-size--medium);font-style:italic">Get notified when new interviews drop. No spam, just ideas worth reading.</p>
<!-- /wp:paragraph -->
